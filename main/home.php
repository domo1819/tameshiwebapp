	...
	<body><!--  人間が見る内容を記述 -->
					...
					<form method="POST" action="home.php">
						...
						?>
							...
							<input type="date" id="da" name="data" style="display:none"><br><br>
									...
									<br><br><br>
									<div class="engine">
							<input type="submit"  name="submit" value="検索" id="submit" class="btn btn-outline-info" style="width:10%;padding:10px;font-size:18px;   margin-bottom:10px; margin-left:15px; text-align: center;">
							</div>
						</div>
					</form>
				</div>
        ...
        <div class = "pp3">  
				<h2 id = "pp">プライバシーポリシー</h2>
				 <br>
					<h3>◆はじめに</h3>
						<p>本プロジェクトのサイトは、個人情報の取り扱いにおいて、下記のように定めます。
						<p>以下のプライバシーポリシーでは、個人情報の取得・利用・管理について記載しております。サービス利用にあたり、個人情報保護方針をお読みになり、ご理解いただけますと幸いです。
