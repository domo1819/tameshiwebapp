					...
					<form method="POST" action="index.php">
						...
						?>
							...
							<input type="date" id="da" name="data" style="display:none"><br><br>
									...
									<br><br><br>
									<div class="engine">
							<input type="submit" value="検索" class="btn_ex13" style="width:10%;padding:10px;font-size:20px; background-color:#00c4ff; color:#FFF; margin-bottom:10px; margin-left: 15px;">
							</div>
						</div>
					</form>
				</div>
