		...
		<main>
			...
			<div class="engine2">
				...
				<?php
					...
					$result = pg_query($conn, "SELECT warn_info.id, warn_info.timestamp, warn_info.punish_id,  warn_info.is_payment, region_data.id, region_data.region_name, car_data.car_classify_num, FROM warn_info, region_data WHERE region_name LIKE '%{$_POST['word']}%'"); 
