			...
			<div class="engine2">
				...
				<form method="POST" action="index.php">
					<div class="engine2">
						...
						<select>
						<?php
							$sql = "SELECT region_name FROM region_data ORDER BY region_name;";
							$col = pg_query($conn, $sql);;
				...
				<?php
					...
					$result = pg_query($conn, "select id,user_id,timestamp,punish_id from warn_info WHERE user_id  LIKE '%{$_POST['word']}%' OR punish_id LIKE '%{$_POST['word']}%'"); 
