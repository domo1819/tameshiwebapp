		...
		<main>
			...
			<div class="engine2">
				...
				<?php
					...
					$result = pg_query($conn, "select id,user_id,timestamp,car_data_id from warn_info WHERE user_id  LIKE '%".$_POST["word"]."%' OR timestamp LIKE '%{$_POST['word']}%' OR car_data_id LIKE '%{$_POST['word']}%' "); 
