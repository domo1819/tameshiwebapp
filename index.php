		...
		<main>
			...
			<div class="engine2">
				...
				<?php
					...
					$result = pg_query($conn, "SELECT warn_info.id,region_data.id, region_data.region_name, car_data.id, car_data.car_region_id, car_data.car_classify_num, car_data.car_classify_hiragana, car_data.car_number, warn_info.timestamp, warn_info.punish_id, warn_info.is_payment FROM warn_info, region_data, car_data WHERE region_name LIKE '%{$_POST['word']}%' OR car_number LIKE '%{$_POST['word']}%'"); 
